// Generated from src\csharp\CSharpPreprocessorParser.g4 by ANTLR 4.7.2
// jshint ignore: start
...
CSharpPreprocessorParser.UNMANAGED = 103;
CSharpPreprocessorParser.UNSAFE = 104;
CSharpPreprocessorParser.USHORT = 105;
CSharpPreprocessorParser.USING = 106;
CSharpPreprocessorParser.VAR = 107;
CSharpPreprocessorParser.VIRTUAL = 108;
CSharpPreprocessorParser.VOID = 109;
CSharpPreprocessorParser.VOLATILE = 110;
CSharpPreprocessorParser.WHEN = 111;
CSharpPreprocessorParser.WHERE = 112;
CSharpPreprocessorParser.WHILE = 113;
CSharpPreprocessorParser.YIELD = 114;
CSharpPreprocessorParser.IDENTIFIER = 115;
CSharpPreprocessorParser.LITERAL_ACCESS = 116;
CSharpPreprocessorParser.INTEGER_LITERAL = 117;
CSharpPreprocessorParser.HEX_INTEGER_LITERAL = 118;
...
CSharpPreprocessorParser.VERBATIM_STRING = 122;
CSharpPreprocessorParser.INTERPOLATED_REGULAR_STRING_START = 123;
CSharpPreprocessorParser.INTERPOLATED_VERBATIM_STRING_START = 124;
...
CSharpPreprocessorParser.DOUBLE_CURLY_INSIDE = 170;
CSharpPreprocessorParser.OPEN_BRACE_INSIDE = 171;
CSharpPreprocessorParser.REGULAR_CHAR_INSIDE = 172;
CSharpPreprocessorParser.VERBATIM_DOUBLE_QUOTE_INSIDE = 173;
CSharpPreprocessorParser.DOUBLE_QUOTE_INSIDE = 174;
CSharpPreprocessorParser.REGULAR_STRING_INSIDE = 175;
CSharpPreprocessorParser.VERBATIM_INSIDE_STRING = 176;
CSharpPreprocessorParser.CLOSE_BRACE_INSIDE = 177;
CSharpPreprocessorParser.FORMAT_STRING = 178;
CSharpPreprocessorParser.DIRECTIVE_WHITESPACES = 179;
CSharpPreprocessorParser.DIGITS = 180;
CSharpPreprocessorParser.DEFINE = 181;
CSharpPreprocessorParser.UNDEF = 182;
CSharpPreprocessorParser.ELIF = 183;
CSharpPreprocessorParser.ENDIF = 184;
CSharpPreprocessorParser.LINE = 185;
CSharpPreprocessorParser.ERROR = 186;
CSharpPreprocessorParser.WARNING = 187;
CSharpPreprocessorParser.REGION = 188;
CSharpPreprocessorParser.ENDREGION = 189;
CSharpPreprocessorParser.PRAGMA = 190;
CSharpPreprocessorParser.DIRECTIVE_HIDDEN = 191;
CSharpPreprocessorParser.CONDITIONAL_SYMBOL = 192;
CSharpPreprocessorParser.DIRECTIVE_NEW_LINE = 193;
CSharpPreprocessorParser.TEXT = 194;
CSharpPreprocessorParser.DOUBLE_CURLY_CLOSE_INSIDE = 195;
    ...
    try {
        ...
        case CSharpPreprocessorParser.DEFINE:
            ...
            this.directive_new_line_or_sharp();
             this.conditionalSymbols.add((localctx._CONDITIONAL_SYMBOL===null ? null : localctx._CONDITIONAL_SYMBOL.text));
        ...
        case CSharpPreprocessorParser.UNDEF:
            ...
            this.state = 13;
            this.directive_new_line_or_sharp();
             this.conditionalSymbols.remove((localctx._CONDITIONAL_SYMBOL===null ? null : localctx._CONDITIONAL_SYMBOL.text));
                   localctx.value =  this.allConditions() 
            break;
        case CSharpPreprocessorParser.IF:
            ...
            this.state = 18;
            this.directive_new_line_or_sharp();
             localctx.value =  localctx.expr.value === "true" && this.allConditions(); this.conditions.push(localctx.expr.value === "true"); 
            break;
        case CSharpPreprocessorParser.ELIF:
            ...
            this.state = 23;
            this.directive_new_line_or_sharp();
             if (!this.conditions[this.conditions.length - 1]) { this.conditions.pop(); localctx.value =  localctx.expr.value === "true" && this.allConditions();
                     this.conditions.push(localctx.expr.value === "true"); } else localctx.value =  false; 
            break;
        case CSharpPreprocessorParser.ELSE:
            ...
            this.state = 27;
            this.directive_new_line_or_sharp();
             if (!this.conditions[this.conditions.length - 1]) { this.conditions.pop(); localctx.value =  true && this.allConditions(); this.conditions.push(true); }
        ...
        case CSharpPreprocessorParser.ENDIF:
            ...
            this.state = 31;
            this.directive_new_line_or_sharp();
             this.conditions.pop(); localctx.value =  this.conditions.peek(); 
            break;
...
CSharpPreprocessorParser.prototype.preprocessor_expression = function(_p) {
    ...
    try {
        ...
        case CSharpPreprocessorParser.CONDITIONAL_SYMBOL:
            this.state = 84;
            localctx._CONDITIONAL_SYMBOL = this.match(CSharpPreprocessorParser.CONDITIONAL_SYMBOL);
             localctx.value =  this.conditionalSymbols.has((localctx._CONDITIONAL_SYMBOL===null ? null : localctx._CONDITIONAL_SYMBOL.text)) ? "true" : "false" 
            break;
            ...
            if(_alt===1) {
                ...
                case 3:
                    ...
                    localctx.expr2 = this.preprocessor_expression(3);
                     localctx.value =  (localctx.expr1.value === "true" && localctx.expr2.value === "true" ? "true" : "false") 
                    break;
